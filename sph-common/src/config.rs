...
/// Checks SPH_PREFIX/HOMEBREW_PREFIX env vars, then OS-specific defaults.
fn determine_prefix() -> PathBuf {
    if let Ok(prefix) = env::var("SPH_PREFIX").or_else(|_| env::var("HOMEBREW_PREFIX")) {
