...
impl From<std::io::Error> for SphError {
    fn from(err: std::io::Error) -> Self {
        SphError::Io(Arc::new(err))
    }
}

impl From<reqwest::Error> for SphError {
    fn from(err: reqwest::Error) -> Self {
        SphError::Http(Arc::new(err))
    }
}

impl From<serde_json::Error> for SphError {
    fn from(err: serde_json::Error) -> Self {
        SphError::Json(Arc::new(err))
    }
}

impl From<semver::Error> for SphError {
    fn from(err: semver::Error) -> Self {
        SphError::SemVer(Arc::new(err))
    }
}

impl From<object::read::Error> for SphError {
    fn from(err: object::read::Error) -> Self {
        SphError::Object(Arc::new(err))
    }
}
