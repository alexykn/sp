// FILE: spm-core/src/build/formula/source/meson.rs
...
pub fn meson_build(
    ...
    let meson_build_subdir_name = "spm-meson-build";
    ...
    let _ninja_exe = which::which_in("ninja", build_env.get_path_string(), build_dir)
        .map_err(|_| SpmError::BuildEnvError("ninja command not found.".to_string()))?;
